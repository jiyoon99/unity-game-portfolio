...
| Project | Genre | Portfolio Point | Run |
| --- | --- | --- | --- |
| VamGame | 2D action survival | 플레이어 성장, 적 스폰, 무기/아이템, 오브젝트 풀링 흐름 | `games/vamgame/Build/VamGame/vam.exe` |
| subakgame | Unity Windows build | Unity 학습 과정에서 완성 빌드까지 만든 실행 결과물 | `games/subakgame/Build/subakgame/subakgame.exe` |
